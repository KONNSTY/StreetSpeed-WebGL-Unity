        ...
        if(Input.GetKey(KeyCode.Space))
        {
            ...
            {   
                ...
                if(Physics.Raycast(transform.position, Vector3.left, out hitInfo1, 100f))
                {
                    ...
                    {
                        hitInfo1.collider.GetComponent<Rigidbody>().AddForce(Vector3.left * 150 * Time.deltaTime, ForceMode.Impulse);
                    }
                }  
                ...
                if(Physics.Raycast(transform.position, Vector3.right, out hitInfo2, 100f))
                {
                    ...
                    {
                        hitInfo2.collider.GetComponent<Rigidbody>().AddForce(Vector3.right * 1000 * Time.deltaTime, ForceMode.Impulse);
                    }
                }
                Energy = 0;
            }
